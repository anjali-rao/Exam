<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="StudentDetailsAdmin.aspx.cs" Inherits="StudentDetailsAdmin" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <%-- The admin views the student details from the register table. --%>
    <br />
    <br />
    <br />
    <br />
